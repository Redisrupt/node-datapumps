    ...
    return function(target) {
      ...
      target.writeHeaders = function(headers, types) {
        ...
        for (index = i = 0, len = headers.length; i < len; index = ++i) {
          ...
          this.columnType(index, (ref = types[index]) != null ? ref : 'String');
        }
      ...
      target.writeRow = function(columns) {
        var cell, i, index, len, ref, value;
        if (this._excel.worksheet == null) {
        ...
        for (index = i = 0, len = columns.length; i < len; index = ++i) {
          ...
          cell[(ref = this._excel.columnTypes[index]) != null ? ref : 'String'](value);
        }
